...
import CommerceOrderPriceNgComponentsPage from './commerce-order-price-ng-my-suffix.page-object';
import CommerceOrderPriceNgUpdatePage from './commerce-order-price-ng-my-suffix-update.page-object';
...
describe('CommerceOrderPriceNg e2e test', () => {
  ...
  it('should load CommerceOrderPriceNgs', async () => {
    navBarPage.getEntityPage('commerce-order-price-ng-my-suffix');
