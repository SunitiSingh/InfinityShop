...
export default class CommerceOrderPriceNgUpdatePage {
  ...
  priceInput: ElementFinder = element(by.css('input#commerce-order-price-ng-my-suffix-price'));
  ngidInput: ElementFinder = element(by.css('input#commerce-order-price-ng-my-suffix-ngid'));
  commerceOrderPriceSelect: ElementFinder = element(by.css('select#commerce-order-price-ng-my-suffix-commerceOrderPrice'));
