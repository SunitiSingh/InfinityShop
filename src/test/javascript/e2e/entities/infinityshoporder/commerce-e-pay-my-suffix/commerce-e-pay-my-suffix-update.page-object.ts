...
export default class CommerceEPayUpdatePage {
  ...
  ePayTypeInput: ElementFinder = element(by.css('input#commerce-e-pay-my-suffix-ePayType'));
  ePayTokenInput: ElementFinder = element(by.css('input#commerce-e-pay-my-suffix-ePayToken'));
  createDateInput: ElementFinder = element(by.css('input#commerce-e-pay-my-suffix-createDate'));
  updateDateInput: ElementFinder = element(by.css('input#commerce-e-pay-my-suffix-updateDate'));
