...
import CommerceOrderComponentsPage from './commerce-order.page-object';
import CommerceOrderUpdatePage from './commerce-order-update.page-object';
...
describe('CommerceOrder e2e test', () => {
  ...
  it('should load CommerceOrders', async () => {
    navBarPage.getEntityPage('commerce-order');
