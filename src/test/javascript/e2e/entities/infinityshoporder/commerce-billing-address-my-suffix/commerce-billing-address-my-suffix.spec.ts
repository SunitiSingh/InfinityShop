...
import CommerceBillingAddressComponentsPage from './commerce-billing-address-my-suffix.page-object';
import CommerceBillingAddressUpdatePage from './commerce-billing-address-my-suffix-update.page-object';
...
describe('CommerceBillingAddress e2e test', () => {
  ...
  it('should load CommerceBillingAddresses', async () => {
    navBarPage.getEntityPage('commerce-billing-address-my-suffix');
