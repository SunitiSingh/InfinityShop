...
import CommerceItemComponentsPage from './commerce-item-my-suffix.page-object';
import CommerceItemUpdatePage from './commerce-item-my-suffix-update.page-object';
...
describe('CommerceItem e2e test', () => {
  ...
  it('should load CommerceItems', async () => {
    navBarPage.getEntityPage('commerce-item-my-suffix');
