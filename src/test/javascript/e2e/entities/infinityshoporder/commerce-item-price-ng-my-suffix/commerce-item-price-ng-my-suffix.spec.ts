...
import CommerceItemPriceNgComponentsPage from './commerce-item-price-ng-my-suffix.page-object';
import CommerceItemPriceNgUpdatePage from './commerce-item-price-ng-my-suffix-update.page-object';
...
describe('CommerceItemPriceNg e2e test', () => {
  ...
  it('should load CommerceItemPriceNgs', async () => {
    navBarPage.getEntityPage('commerce-item-price-ng-my-suffix');
