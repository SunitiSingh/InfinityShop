...
export default class CommerceItemPriceNgUpdatePage {
  ...
  priceInput: ElementFinder = element(by.css('input#commerce-item-price-ng-my-suffix-price'));
  ngidInput: ElementFinder = element(by.css('input#commerce-item-price-ng-my-suffix-ngid'));
  commerceItemPriceSelect: ElementFinder = element(by.css('select#commerce-item-price-ng-my-suffix-commerceItemPrice'));
