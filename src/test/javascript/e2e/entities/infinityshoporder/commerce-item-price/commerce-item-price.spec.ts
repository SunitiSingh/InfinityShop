...
import CommerceItemPriceComponentsPage from './commerce-item-price.page-object';
import CommerceItemPriceUpdatePage from './commerce-item-price-update.page-object';
...
describe('CommerceItemPrice e2e test', () => {
  ...
  it('should load CommerceItemPrices', async () => {
    navBarPage.getEntityPage('commerce-item-price');
