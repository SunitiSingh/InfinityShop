...
export default class CommerceOrderUpdatePage {
  ...
  statusSelect: ElementFinder = element(by.css('select#commerce-order-my-suffix-status'));
  custidInput: ElementFinder = element(by.css('input#commerce-order-my-suffix-custid'));
  creationDateInput: ElementFinder = element(by.css('input#commerce-order-my-suffix-creationDate'));
  placedDateInput: ElementFinder = element(by.css('input#commerce-order-my-suffix-placedDate'));
  updateDateInput: ElementFinder = element(by.css('input#commerce-order-my-suffix-updateDate'));
