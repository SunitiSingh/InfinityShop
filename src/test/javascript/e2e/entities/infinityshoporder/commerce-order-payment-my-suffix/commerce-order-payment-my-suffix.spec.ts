...
import CommerceOrderPaymentComponentsPage from './commerce-order-payment-my-suffix.page-object';
import CommerceOrderPaymentUpdatePage from './commerce-order-payment-my-suffix-update.page-object';
...
describe('CommerceOrderPayment e2e test', () => {
  ...
  it('should load CommerceOrderPayments', async () => {
    navBarPage.getEntityPage('commerce-order-payment-my-suffix');
