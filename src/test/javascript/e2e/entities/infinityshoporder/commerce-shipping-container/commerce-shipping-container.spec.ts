...
import CommerceShippingContainerComponentsPage from './commerce-shipping-container.page-object';
import CommerceShippingContainerUpdatePage from './commerce-shipping-container-update.page-object';
...
describe('CommerceShippingContainer e2e test', () => {
  ...
  it('should load CommerceShippingContainers', async () => {
    navBarPage.getEntityPage('commerce-shipping-container');
