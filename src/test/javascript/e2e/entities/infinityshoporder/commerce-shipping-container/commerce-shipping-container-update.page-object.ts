...
export default class CommerceShippingContainerUpdatePage {
  ...
  shipstatusSelect: ElementFinder = element(by.css('select#commerce-shipping-container-shipstatus'));
  carrierInput: ElementFinder = element(by.css('input#commerce-shipping-container-carrier'));
  creationDateInput: ElementFinder = element(by.css('input#commerce-shipping-container-creationDate'));
  updateDateInput: ElementFinder = element(by.css('input#commerce-shipping-container-updateDate'));
  commerceOrderSelect: ElementFinder = element(by.css('select#commerce-shipping-container-commerceOrder'));
  priceSelect: ElementFinder = element(by.css('select#commerce-shipping-container-price'));
