...
import CommerceShipPriceNgComponentsPage from './commerce-ship-price-ng-my-suffix.page-object';
import CommerceShipPriceNgUpdatePage from './commerce-ship-price-ng-my-suffix-update.page-object';
...
describe('CommerceShipPriceNg e2e test', () => {
  ...
  it('should load CommerceShipPriceNgs', async () => {
    navBarPage.getEntityPage('commerce-ship-price-ng-my-suffix');
