...
export default class CommerceShipPriceNgUpdatePage {
  ...
  priceInput: ElementFinder = element(by.css('input#commerce-ship-price-ng-my-suffix-price'));
  commerceShipContainerPriceSelect: ElementFinder = element(by.css('select#commerce-ship-price-ng-my-suffix-commerceShipContainerPrice'));
