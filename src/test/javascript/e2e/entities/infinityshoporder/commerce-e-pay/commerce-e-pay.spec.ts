...
import CommerceEPayComponentsPage from './commerce-e-pay.page-object';
import CommerceEPayUpdatePage from './commerce-e-pay-update.page-object';
...
describe('CommerceEPay e2e test', () => {
  ...
  it('should load CommerceEPays', async () => {
    navBarPage.getEntityPage('commerce-e-pay');
