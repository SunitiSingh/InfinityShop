...
export default class CommerceOrderPaymentUpdatePage {
  ...
  paystatusSelect: ElementFinder = element(by.css('select#commerce-order-payment-paystatus'));
  paymentAmountInput: ElementFinder = element(by.css('input#commerce-order-payment-paymentAmount'));
  paymentTypeSelect: ElementFinder = element(by.css('select#commerce-order-payment-paymentType'));
  firstNameInput: ElementFinder = element(by.css('input#commerce-order-payment-firstName'));
  lastNameInput: ElementFinder = element(by.css('input#commerce-order-payment-lastName'));
  billingPhoneInput: ElementFinder = element(by.css('input#commerce-order-payment-billingPhone'));
  commerceOrderSelect: ElementFinder = element(by.css('select#commerce-order-payment-commerceOrder'));
  cardSelect: ElementFinder = element(by.css('select#commerce-order-payment-card'));
  epaySelect: ElementFinder = element(by.css('select#commerce-order-payment-epay'));
  billingAddressSelect: ElementFinder = element(by.css('select#commerce-order-payment-billingAddress'));
