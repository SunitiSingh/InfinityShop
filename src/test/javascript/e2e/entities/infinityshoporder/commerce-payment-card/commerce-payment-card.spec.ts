...
import CommercePaymentCardComponentsPage from './commerce-payment-card.page-object';
import CommercePaymentCardUpdatePage from './commerce-payment-card-update.page-object';
...
describe('CommercePaymentCard e2e test', () => {
  ...
  it('should load CommercePaymentCards', async () => {
    navBarPage.getEntityPage('commerce-payment-card');
