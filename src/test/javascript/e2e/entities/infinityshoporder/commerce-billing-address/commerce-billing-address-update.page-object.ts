...
export default class CommerceBillingAddressUpdatePage {
  ...
  address1Input: ElementFinder = element(by.css('input#commerce-billing-address-address1'));
  address2Input: ElementFinder = element(by.css('input#commerce-billing-address-address2'));
  cityInput: ElementFinder = element(by.css('input#commerce-billing-address-city'));
  postalcodeInput: ElementFinder = element(by.css('input#commerce-billing-address-postalcode'));
  createDateInput: ElementFinder = element(by.css('input#commerce-billing-address-createDate'));
  updateDateInput: ElementFinder = element(by.css('input#commerce-billing-address-updateDate'));
