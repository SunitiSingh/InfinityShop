...
import CommerceShipContainerPriceComponentsPage from './commerce-ship-container-price-my-suffix.page-object';
import CommerceShipContainerPriceUpdatePage from './commerce-ship-container-price-my-suffix-update.page-object';
...
describe('CommerceShipContainerPrice e2e test', () => {
  ...
  it('should load CommerceShipContainerPrices', async () => {
    navBarPage.getEntityPage('commerce-ship-container-price-my-suffix');
