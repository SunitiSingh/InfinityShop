...
import CommerceOrderPriceComponentsPage from './commerce-order-price-my-suffix.page-object';
import CommerceOrderPriceUpdatePage from './commerce-order-price-my-suffix-update.page-object';
...
describe('CommerceOrderPrice e2e test', () => {
  ...
  it('should load CommerceOrderPrices', async () => {
    navBarPage.getEntityPage('commerce-order-price-my-suffix');
