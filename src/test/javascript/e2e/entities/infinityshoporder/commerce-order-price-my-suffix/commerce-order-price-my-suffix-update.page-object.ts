...
export default class CommerceOrderPriceUpdatePage {
  ...
  nameInput: ElementFinder = element(by.css('input#commerce-order-price-my-suffix-name'));
  priceInput: ElementFinder = element(by.css('input#commerce-order-price-my-suffix-price'));
  commerceOrderSelect: ElementFinder = element(by.css('select#commerce-order-price-my-suffix-commerceOrder'));
